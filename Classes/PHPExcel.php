...
class PHPExcel
{
    ...
    */
     ...
     */
    public function setSecurity($pValue)
    {
     ...
     * @throws PHPExcel_Exception
     */
    public function addSheet($pSheet, $iSheetIndex = null)
    {
     ...
     * @return PHPExcel_Worksheet
     */
    public function addExternalSheet($pSheet, $iSheetIndex = null)
    {
        if ($this->sheetNameExists($pSheet->getTitle())) {
     ...
     * @return boolean
     */
    public function addNamedRange($namedRange)
    {
