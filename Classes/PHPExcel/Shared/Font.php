...
class PHPExcel_Shared_Font
{
     ...
     */
    public static function calculateColumnWidth($font, $cellText = '', $rotation = 0, $defaultFont = null)
    {
     ...
     */
    public static function getTextWidthPixelsExact($text, $font, $rotation = 0)
    {
