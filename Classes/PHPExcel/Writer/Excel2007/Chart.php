...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeTitle($title = null, $objWriter)
    {
        if (is_null($title)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeLegend($legend = null, $objWriter)
    {
        if (is_null($legend)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writePlotArea($plotArea, $xAxisLabel = null, $yAxisLabel = null, $objWriter, $pSheet, $xAxis, $yAxis, $majorGridlines, $minorGridlines)
    {
        if (is_null($plotArea)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeCategoryAxis($objWriter, $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis)
    {
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeValueAxis($objWriter, $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines)
    {
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writePlotGroup($plotGroup, $groupType, $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType, $pSheet)
    {
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, $dataType = 'str', $pSheet)
    {
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeBubbles($plotSeriesValues, $objWriter, $pSheet)
    {
        if (is_null($plotSeriesValues)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeLayout($layout = null, $objWriter)
    {
