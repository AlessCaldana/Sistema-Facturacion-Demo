...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    private function extendRowsForChartsAndImages($pSheet, $row)
    {
        $rowMax = $row;
        $colMax = 'A';
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeImageInCell($pSheet, $coordinates)
    {
        // Construct HTML
        $html = '';
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function writeChartInCell($pSheet, $coordinates)
    {
        // Construct HTML
        $html = '';
     ...
     * @return    array
     */
    private function createCSSStyle($pStyle)
    {
        // Construct CSS
        $css = '';
     ...
     * @return    array
     */
    private function createCSSStyleAlignment($pStyle)
    {
        // Construct CSS
        $css = array();
     ...
     * @return    array
     */
    private function createCSSStyleFont($pStyle)
    {
        // Construct CSS
        $css = array();
     ...
     * @return    array
     */
    private function createCSSStyleBorders($pStyle)
    {
        // Construct CSS
        $css = array();
     ...
     * @return    string
     */
    private function createCSSStyleBorder($pStyle)
    {
        // Create CSS
//        $css = $this->mapBorderStyle($pStyle->getBorderStyle()) . ' #' . $pStyle->getColor()->getRGB();
     ...
     * @return    array
     */
    private function createCSSStyleFill($pStyle)
    {
        // Construct HTML
        $css = array();
     ...
     * @throws    PHPExcel_Writer_Exception
     */
    private function generateRow($pSheet, $pValues = null, $pRow = 0, $cellType = 'td')
    {
        if (is_array($pValues)) {
            // Construct HTML
            $html = '';
    ...
    private function setMargins($pSheet)
    {
        $htmlPage = '@page { ';
        $htmlBody = 'body { ';
