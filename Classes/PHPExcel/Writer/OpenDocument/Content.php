...
class PHPExcel_Writer_OpenDocument_Content extends PHPExcel_Writer_OpenDocument_WriterPart
{
     ...
     */
    private function writeSheets($objWriter)
    {
        $pPHPExcel = $this->getParentWriter()->getPHPExcel(); /* @var $pPHPExcel PHPExcel */
     ...
     */
    private function writeRows($objWriter, $sheet)
    {
     ...
     * @throws PHPExcel_Writer_Exception
     */
    private function writeCells($objWriter, $row)
    {
     ...
     */
    private function writeCellSpan($objWriter, $curColumn, $prevColumn)
    {
