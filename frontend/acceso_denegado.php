<?php
/* acceso_denegado.php â€” limpio, sin mÃ³dulo/acciÃ³n ni fecha/hora */
session_start();
...
/* Si tu plantilla anterior traÃ­a $mod y $acc, simplemente NO los usamos */
?>
<!doctype html>
<html lang="es">
<head>
...
<body>
  <div class="box">
    ...
    <!-- BotÃ³n volver -->
    <a class="btn" href="menu_principal.php">Volver al menÃº</a>
  </div>
</body>
</html>
