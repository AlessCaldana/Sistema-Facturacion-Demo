 ...
 */
    class QRsplit {
        ...
        //----------------------------------------------------------------------
        public static function splitStringToQRinput($string, $input, $modeHint, $casesensitive = true)
        {
 ...
 */
    ...
    class QRrsblock {
        ...
        public function __construct($dl, $data, $el, &$ecc, $rs)
        {
    ...
    class QRcode {
        ...
        //----------------------------------------------------------------------
        public function encodeMask($input, $mask)
        {
